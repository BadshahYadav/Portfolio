      ...
      <section className="flex flex-col-reverse lg:flex-row lg:p-6 p-4 gap-6 mt-6">
        ...
        <section className="w-full p-3 flex flex-col justify-start gap-4 text-xl rounded-xl py-6 shadow-sm lg:p-6 card">
          ...
          <p className="lg:text-xl text-lg text-gray-700 font-normal">
            Hello! I&apos;m Badshah Kumar, a passionate and dedicated 4th-year
            Computer Science student at BCE PATNA.
          </p>
          <p className="lg:text-xl text-lg text-gray-700 font-normal">
          ...
          <section className="flex max-md:flex-col gap-6 md:items-center">
            ...
            <section className="flex items-center gap-4 mt-3">
              {/* Linkedin */}
              <a
                href="https://www.linkedin.com/in/badshah-kumar-830146234/"
                target="_blank"
                rel="noreferrer"
              ...
              {/* Github */}
              <a
                href="https://github.com/BadshahYadav"
                target="_blank"
                rel="noreferrer"
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/_emperor_4k/"
                target="_blank"
                rel="noreferrer"
            ...
            <section className="flex gap-4">
              <Link href="mailto:badshahkumar1508@gmail.com">
              <button
