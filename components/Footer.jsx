  ...
  const social = [
    {
      id: 1,
      name: "Linkedin",
      link: "https://www.linkedin.com/in/badshah-kumar-830146234/",
      icon: <FaExternalLinkAlt />,
    },
    {
      id: 2,
      name: "Github",
      link: "https://github.com/BadshahYadav",
      icon: <FaExternalLinkAlt />,
    },
    // {
    //   id: 3,
    ...
    },
    {
      id: 5,
      name: "Instagram",
      link: "https://www.instagram.com/_emperor_4k/",
      icon: <FaExternalLinkAlt />,
    },
  ];
        ...
        <section className="p-2 w-full flex flex-col items-center">
          ...
          <section className="p-2 flex flex-col items-center w-fit gap-2 text-gray-800">
            <span className="flex gap-1 items-center">
              <FaLocationDot />
              <address> Madhepura, Bihar, India</address>
            </span>
            <span className="flex gap-2 items-center">
              <IoIosMail className="text-xl" />
              <Link href="mailto:badshahkumar1508@gmail.com">
              badshahkumar1508@gmail.com
              </Link>
            </span>
          </section>
        </section>
